...
local Window = redzlib:MakeWindow({
    Title = "Pure Hub : Blox Fruit",
    SubTitle = "by Pure Hub",
    SaveFolder = "PureHubBF.json"
})

-- Pure Hub background image
pcall(function()
    if Window.SetBackgroundImage then
        Window:SetBackgroundImage("rbxassetid://118511104078279")
    end
end)
...
local MobileButton = Minimizer:CreateMobileMinimizer({
  Image = "rbxassetid://118511104078279",
...
Tabs.Info:AddDiscordInvite({
	Title = "Pure Hub | Community",
	Description = "A community for Pure Hub Users - official scripts, updates, and support in one place.",
	Banner = "rbxassetid://118511104078279", 
	Logo = "rbxassetid://118511104078279",
	Invite = "https://discord.gg/jbpHCD3v3",
	Members = 36, 
	Online = 67, 
})
...
Callback = function(Value)
  ...
  if Value == true then
    ...
    -- Do not force dark ambient (was causing black screen on load)
...
-- Pure Hub: Fix dark screen + slow walk on load
pcall(function()
